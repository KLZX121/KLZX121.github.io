    ...
    document.onkeydown = event => {
        ...
        switch (event.code){
            ...
            case 'Space': //dots or dashes
                //prevent scrolling when info is shown
